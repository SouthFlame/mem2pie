...
public class OSCCommandsExecute extends HttpAsyncTask {
    ...
    public enum CommandType {STRING, IMAGE, VIDEO, PREVIEW}
    ...
    public OSCCommandsExecute(String command, JSONObject parameters) {
        ...
        super(HTTP_SERVER_INFO.IP + ":" + HTTP_SERVER_INFO.PORT + "/osc/commands/execute",
    ...
    public static String getFileLocation() {
        ...
        return dcimDirectory + "/friendsCamera";
    }
